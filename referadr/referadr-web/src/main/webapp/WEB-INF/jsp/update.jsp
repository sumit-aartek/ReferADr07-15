...
<form:form id="formID" method="POST" action="updateAdditionalNotes.do" modelAttribute="Referral_Provider_Action" autocomplete="off" name="form" target="_top" enctype="multipart/form-data" >
<!-- 
