...
<html class="no-js" lang="en">
  <head>
	...
	{ 
 	...
 	function funForEnableDrpoDown(){
		
		document.getElementById('practiceSpectialtyId').disabled=false;
		document.getElementById('chearingHouseId').disabled=false;
	} 
...
$(document).ready(function() {
	    ...
	    /*  if(provider==1){
	     ...
	     var chInfoId="${PatientReferralInfo.chInfo.id}";
	     var specilityId="${PatientReferralInfo.practiceSpecialty.praticeSplID}";
	   //  alert(chInfoId+specilityId); 
	        ...
	        $.ajax({
	          ...
	          success : function(t) {
	            ...
	            for (i = 0; i < e.length; i++){
	              ...
	              document.getElementById('practiceSpectialtyId').value=specilityId;
	            }
...
<form:form id="formID" method="POST" action="chUpdateRefferal.do?fromProviderId=${fromProviderId}" modelAttribute="PatientReferralInfo" autocomplete="off" enctype="multipart/form-data" >
...
<div id="all">
     <div class="small-12 medium-6 large-3 columns" id='providerdropdowm'>
			<span id='providermsg'></span>				<form:select path="proId" id="refproviderId" readonly="true" onchange="fillProviderId()">
...
<%-- <div class="small-12 medium-12 large-12 columns">
   <form:textarea path="referral_Provider_ActionList[0].providerRefReasons" placeholder="Referal Reason" id="PrvoRederalReason" class="validate[required] text-input" />
</div>
<div class="small-12 medium-12 large-12 columns">
...
<div class="small-12 medium-6 large-3 columns">
   <form:select path="chInfo.id" id="chearingHouseId" disabled="true">
         <form:option value="0" label="Select" />
...
<div class="small-12 medium-6 large-3 columns">
  ...
  <form:select path="practiceSpecialty.praticeSplID" id="practiceSpectialtyId" disabled="true">
         <form:option value="0" label="Select" />
        </form:select>
</div><!---small-12 medium-6 large-3 columns---->
<div class="small-12 medium-6 large-3 columns">
...
<hr>
<div class="buttons-blue-container">
<input type="submit" name="Submit" value="Submit" class="small radius button" onClick="funForEnableDrpoDown()">
</div>
</form:form>
