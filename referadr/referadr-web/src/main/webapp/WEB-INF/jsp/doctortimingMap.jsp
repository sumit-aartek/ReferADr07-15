...
<!--Accordion CSS-->
	...
	$(function() {
		...
		jQuery(document).ready(function() {
			...
			newTextBoxDiv.after().html('<fieldset><input type="text"  class="abc" required="true" name="doctorTimingVO[${list.dayID}].startTime" value="${list.startTime}" id="input_from"></fieldset>');
			newTextBoxDiv.appendTo("#startdiv${list.dayID}");

			var newTextBoxDiv = $(document.createElement('div'))
			.attr("id", 'bb' +${list.dayID}+counter1 );
		newTextBoxDiv.after().html('<fieldset><input type="text"  class="abc" required="true" name="doctorTimingVO[${list.dayID}].endTime" value="${list.endTime}" id="input_to"></fieldset>');
...
var newTextBoxDiv = $(document.createElement('div'))
.attr("id", 'aa' +j+'1');
newTextBoxDiv.after().html('<fieldset><input type="text"   class="abc" required="true" name="doctorTimingVO['+j+'].startTime" id="input_from"></fieldset>');
newTextBoxDiv.appendTo("#startdiv"+j);

var newTextBoxDiv = $(document.createElement('div'))
.attr("id", 'bb' +j+'1' );
newTextBoxDiv.after().html('<fieldset><input type="text"   class="abc" required="true" name="doctorTimingVO['+j+'].endTime"  id="input_to"></fieldset>');
...
function closecheckboxclicked(dayid){
		...
		if(status){
			...
			var newTextBoxDiv = $(document.createElement('div'))
			.attr("id", 'aa' +dayid+'1' );
			newTextBoxDiv.after().html('<fieldset><input type="text"   class="abc" required="true" name="doctorTimingVO['+dayid+'].startTime" id="input_from"></fieldset>');
			newTextBoxDiv.appendTo("#startdiv"+dayid);

			var newTextBoxDiv = $(document.createElement('div'))
			.attr("id", 'bb' +dayid+'1' );
			newTextBoxDiv.after().html('<fieldset><input type="text"   class="abc" required="true" name="doctorTimingVO['+dayid+'].endTime"  id="input_to"></fieldset>');
